...
class NoHelperDependingOnBootedApplicationUsageRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        if (array_key_exists($functionName, self::GLOBAL_HELPERS_ALTERNATIVES) === false) {
            return [];
        }

        return [
            RuleErrorBuilder::message(
                'Usage of the global function "' . $functionName . '" is highly dependent on a booted application and makes ' .
                'this code tightly coupled. Instead, ' . self::GLOBAL_HELPERS_ALTERNATIVES[$functionName].'.'
